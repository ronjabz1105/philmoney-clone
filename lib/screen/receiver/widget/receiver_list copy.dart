                      ...
                      child: Obx(
                        () => ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            //ReceiverModel receiver = controller.dbReceiver[index];
                ...
                Column(
                  children: [
                    ...
                    Expanded(
                      child: Obx(
                        () => ListView.builder(
                            //itemCount: controller.dbReceiver.length,
                                  ...
                                  builder: (context) {
                                    return Column(
                                      children: [
                                        ...
                                        //   controller.allReceiversPickUp.length ==
                                        //           index - 1
                                        //       ? GestureDetector(
                                        //           onTap: () {
                                        //             controller

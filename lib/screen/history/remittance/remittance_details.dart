...
import 'package:philmoney/screen/history/widget/progress_timeline.dart';

import '../index.dart';

class RemittanceDetails extends GetView<HistoryController> {
  RemittanceDetails({
    Key? key,
    required this.thisremittanceId,
    required this.thisreceiverId,
  }) : super(key: key);
  String thisremittanceId;
  String thisreceiverId;

  @override
  Widget build(BuildContext context) {
    ReceiverModel receiver =
        controller.getReceiverInfoFromThisDocId(thisreceiverId);
    RemittanceModel remittance =
        controller.getRemittanceInfoFromThisDocId(thisremittanceId);
